...
class DataFeed:
    def __init__(self):
        ...
        opts = pd.read_excel(os.path.join(p, 'data/300etf期权列表.xlsx'))
        ...
        print(opts.head())
        df = pd.read_excel(os.path.join(p, 'data/300etf期权.xlsx'))
        df = df[df['type'] == 'call']
        ...
        etf = pd.read_excel(os.path.join(p, 'data/300etf.xlsx'))
...
if __name__ == "__main__":
    ...
    cerebro.addstrategy(CoveredCall, **params)
